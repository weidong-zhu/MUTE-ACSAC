...
extern uint64_t flash_read(struct ssd *ssd, NvmeRequest *req);
extern uint64_t flash_write(struct ssd *ssd, NvmeRequest *req);
//extern uint64_t flash_read_erase_blk(struct ssd *ssd, NvmeRequest *req);
extern uint64_t flash_write_lpn(struct ssd *ssd, uint64_t lpn, uint64_t s_time);

extern uint64_t nvm_flash_write(struct ssd *ssd, NvmeRequest *req);
extern uint64_t nvm_flash_read(struct ssd *ssd, NvmeRequest *req);
extern void fde_encryption(struct ssd *ssd, uint16_t len, const uint8_t *src, uint8_t *dst, uint8_t *iv);

extern void fde_decryption(struct ssd *ssd, uint16_t len, const uint8_t *src, uint8_t *dst, uint8_t *iv);
